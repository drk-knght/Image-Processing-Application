...
public class SplitChannelTest {
  ...
  private boolean checkImageStringFormat(RGBImageInterface singleChannelImage, int [][][] mat, int color) throws IOException {
    singleChannelImage.saveImage("/Users/omagarwal/Desktop/Grad@NEU/Acads/Sem-1/CS 5010 PDP/Labs/Image Processing/src/res/small-Res-singleChannel-Testing.ppm");
    StringBuilder savedRes = convertImageMatrixToString(singleChannelImage.getImageHeight(), singleChannelImage.getImageWidth(), singleChannelImage.getPixel());
