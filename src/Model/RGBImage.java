...
public class RGBImage implements RGBImageInterface {
   ...
   * @throws IOException Throws exception if the file path is invalid or don't have access to read.
   * @throws NullPointerException Throws exception if the file path is empty.
   */
